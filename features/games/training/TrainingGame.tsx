...
export default function TrainingGame({ gameId, onExit }: { gameId: TrainingGameId; onExit: () => void }) {
  ...
  const needsSound = gameId === 'ear-training';
...
const styles = StyleSheet.create({
  ...
  soundWarning: { color: Colors.warning, lineHeight: 20, textAlign: 'center', fontWeight: '700' }, disabled: { opacity: 0.4 },
});
